...
int main()
{
    ...
    ofstream output_file("students.bin", ios::binary);
    output_file.write((char*)&apprentice, sizeof(apprentice));
    output_file.close();

    // Reading from it
    //ifstream input_file("students.bin", ios::binary);
    // /Users/Anh/src/CppProject/BinTest1/identify1.bin
    ifstream input_file("/Users/Anh/src/CppProject/BinTest1/identify1.bin", ios::binary);
    student_t master[3];
